...
<Note>
Near AI models are hosted and served by <a href="https://cloud.near.ai">Near AI</a>.
Meta Llama and Anthropic models are hosted and served by <a href="https://openrouter.ai">OpenRouter</a>.
For free local inference, <a href="https://ollama.ai">Ollama</a> supports models like llama3.2, mistral, and phi3 with no API costs.
</Note>
